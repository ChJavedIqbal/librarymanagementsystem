    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ml-auto">
                ...
                <li class="px-3">
                    <button type="button" class="btn btn-outline-primary editRecord" data-bs-toggle="modal"
                            data-bs-target="#editProfileModal">{{__('lang.Profile')}}</button>
                    <a href="/logout">
                        <button type="button" class="btn btn-outline-primary">{{__('lang.Logout')}}</button>
                    </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <button type="submit" class="btn btn-primary close" data-dismiss="modal"
                            id="update_form">{{__('lang.Update')}}</button>
                </div>
            </div>
...
<div class="d-inline-flex p-2 my-5 float-end">
    <div class="input-group">
        <input type="search" class="form-control rounded searchbar" value="" placeholder="Search here...."
               aria-label="Search" aria-describedby="search-addon"/>
        <button type="button" class="btn btn-outline-primary me-2 searchBtn">{{__('lang.Search')}}</button>
        <a href="/user">
            <button type="button" class="btn btn-primary me-2">{{__('lang.Reset')}}</button>
        </a>
    </div>
</div>
