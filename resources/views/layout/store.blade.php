...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <input type="hidden" class="form-control" value="user" name="role" id="role">
    </div>

    <button type="submit" class="btn btn-primary" id="store_Form">{{__('lang.submit')}}</button>
</div>
{{--    </form>--}}

{{--</div>--}}
<script src="{{ asset('js/storeuserbyAdmin.js')}}"></script>
